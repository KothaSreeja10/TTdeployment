...
export default function UseExample() {
  ...
  const submit = async (e) => {
    ...
    try {
      await addSkill(form)
      setMsg({ text:'✅ Skill added!', type:'success' })
      setForm({ name:'', category:'' }); load()
        ...
        <div className="card">
          ...
          <form onSubmit={submit} style={{ display:'flex', flexDirection:'column', gap:'14px' }}>
            <div className="form-group">
              ...
              <input placeholder="e.g. Java, SQL" value={form.name} onChange={e => setForm({...form,name:e.target.value})} required />
            </div>
            <div className="form-group">
